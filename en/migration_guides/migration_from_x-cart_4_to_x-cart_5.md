...
*   [Introduction](#MigrationfromX-Cart4toX-Cart5-Introduction)
*   [Table of contents](#MigrationfromX-Cart4toX-Cart5-Tableofcontents)
*   [Data migration](#MigrationfromX-Cart4toX-Cart5-Datamigration)
    *   [Step 1\. Decide what data you want to migrate.](#MigrationfromX-Cart4toX-Cart5-Step1.Decidewhatdatayouwanttomigrate.)
    *   [Step 2\. Decide who is going to run migration task.](#MigrationfromX-Cart4toX-Cart5-Step2.Decidewhoisgoingtorunmigrationtask.)
        *   [Step 2a. Migrating data by yourself](#MigrationfromX-Cart4toX-Cart5-Step2a.Migratingdatabyyourself)
        *   [Step 2b. Migrating data with paid help](#MigrationfromX-Cart4toX-Cart5-Step2b.Migratingdatawithpaidhelp)
*   [Migration of your custom functionality and design](#MigrationfromX-Cart4toX-Cart5-Migrationofyourcustomfunctionalityanddesign)
*   [Summary](#MigrationfromX-Cart4toX-Cart5-Summary)
...
In this case, export data from X-Cart 4 and adjust it according to [X-Cart 5 import format](Import-Export_7503874.html), then import it into X-Cart 5.
...
In order to migrate all your preferred features that do not exist in X-Cart 5 as well as migrate the custom layout of your store, you should re-implement such changes to X-Cart 5 from scratch. Our [developer documentation](Developer-docs_7077893.html) will be very helpful for such task.
