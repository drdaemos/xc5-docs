...
3.  We create the `<X-Cart>/classes/XLite/Module/Tony/PaymentFormDemo/install.yaml` file with the following content: 
    ...
    _Note: do not forget to [push this file into the database]({{ baseurl_lang }}/developer_docs/getting_started/x-cart_sdk.html#X-CartSDK-LoadingYAMLfile)._
