...
In order to register some CSS/JS resources in your viewer class (more about this in [Working with viewer classes]({{ baseurl_lang }}/developer_docs/basics/working_with_viewer_classes.html)), it should implement two specific methods: `getCSSFiles() and ``getJSFiles().`
