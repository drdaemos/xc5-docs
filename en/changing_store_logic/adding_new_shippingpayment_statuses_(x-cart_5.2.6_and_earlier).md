...
{% highlight php %}INSERT INTO xc_order_payment_statuses (code, position) VALUES ("YOUR-CODE", "80");{% endhighlight %}
...
{% highlight php %}SELECT id FROM xc_order_payment_statuses WHERE code="YOUR-CODE";{% endhighlight %}

This way we are getting an ID of this newly created payment status.

**Step 3**. Run the following MySQL query:

{% highlight php %}INSERT INTO xc_order_payment_status_translations (id, name, customerName, code) VALUES ("ID-RECEIVED-IN-STEP-2", "Admin name", "Customer name", "en");{% endhighlight %}
...
{% highlight php %}INSERT INTO xc_order_shipping_statuses (code, position) VALUES ("YOUR-CODE", "70");{% endhighlight %}
...
{% highlight php %}SELECT id FROM xc_order_shipping_statuses WHERE code="YOUR-CODE";{% endhighlight %}

This way we are getting an ID of this newly created shipping status.

**Step 3**. Run the following MySQL query:

{% highlight php %}INSERT INTO xc_order_shipping_status_translations (id, name, customerName, code) VALUES ("ID-RECEIVED-IN-STEP-2", "Admin shipping name", "Customer shipping name", "en");{% endhighlight %}
...
{% highlight php %}INSERT INTO xc_order_shipping_status_translations (id, name, customerName, code) VALUES ("SHIPPING-STATUS-ID", "Admin shipping name in your language", "Customer shipping name in your language", "YOUR-LANGUAGE-CODE");{% endhighlight %}
